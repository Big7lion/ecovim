...
lspconfig.cssls.setup({
  ...
  handlers = handlers,
  on_attach = require("lsp.servers.css").on_attach,
  settings = require("lsp.servers.css").settings,
})
...
lspconfig.jsonls.setup({
  ...
  handlers = handlers,
  on_attach = on_attach,
  settings = require("lsp.servers.json").settings,
})
...
lspconfig.lua_ls.setup({
  ...
  handlers = handlers,
  on_attach = on_attach,
  settings = require("lsp.servers.lua").settings,
})
